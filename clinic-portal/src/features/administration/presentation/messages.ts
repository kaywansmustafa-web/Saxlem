...
const ku: AdministrationMessages = {administration:"رێڤەبەری",administrationHelp:"رێکخراو و کلینیکان بو پلاتفورما ساخلەم زێدە بکە.",organizations:"رێکخراو",organization:"رێکخراو",organizationName:"ناڤێ رێکخراوێ",organizationsHelp:"رێکخراوێن نوکە تومارکری ل ساخلەم ببینە.",createOrganization:"رێکخراوەکێ چێکە",organizationCreated:"رێکخراو هاتە دروستکرن",noOrganizations:"هێشتا چ رێکخراو نەهاتیە دروستکرن.",viewOrganization:"رێکخراوی ببینە",clinics:"کلینیک",clinic:"کلینیک",clinicName:"ناڤێ کلینیکێ",clinicCode:"کودێ کلینیکێ",clinicsHelp:"کلینیکێن د رێکخراوێن تومارکری دا ببینە.",createClinic:"کلینیکەکێ زێدە بکە",clinicCreated:"کلینیک هاتە دروستکرن",noClinics:"هێشتا چ کلینیک نەهاتیە دروستکرن.",viewClinic:"کلینیکێ ببینە",selectOrganization:"رێکخراو هەلبژێرە",clinicsInOrganization:"کلینیکێن رێکخراوێ",onboardClinic:"کلینیکەکێ زێدە بکە",active:"چالاک",inactive:"نەچالاک",status:"رەوش",created:"هاتە چێکرن",updated:"دویماهیک نویکرن",identifier:"ناسنامە",timezone:"ناڤچەیا دەمێ",required:"ئەڤ خانە پێدڤییە.",invalidValue:"بهایەکێ دروست بنڤیسە",maximumLength:"بها زۆر درێژە.",invalidCode:"2–32 پیت، ژمارە، _ یان - بکاربینە.",invalidTimezone:"ناوچەیا دەمێ یا IANA وەک Asia/Baghdad بنڤیسە.",duplicateClinicCode:"ئەو کودێ کلینیکێ ژبەری د ڤی رێکخراوی دا هاتیە بکارئینان.",create:"دروستبکە",creating:"دهێتە دروستکرن…",cancel:"ب هەلوەشینە",retry:"دیسان هەول بدە",loadMore:"پتر بار بکە",loading:"دهێتە بارکرن…",loadingOrganizations:"رێکخراو دهێنە بارکرن…",organizationSelectionLimit:"لیستا رێکخراوان زۆر مەزنە و ب پاراستی ناهێتە نیشاندان. بەری دیسان هەول بدەی، رێکخراوان بپشکنە.",loadingClinics:"کلینیک دهێنە بارکرن…",unavailable:"خزمەتگوزاریێن ساخلەم بو دەمکی بەردەست نینن.",forbidden:"دەستگەهیشتن بۆ ڤێ بەشێ نینە.",sessionExpired:"دانیشتنا تە دوماهی هات. دیسان بچۆ ژوور.",notFound:"تۆمار نەهاتە دیتن.",failure:"کێشەیەک روو دا. چ گوهۆڕینەکا نەپاراستی نەهاتە کرن.",conflict:"ئەڤ زانیاری ل گەل تومارەکێ هەیی ناکۆکە.",validation:"زانیاریێن دیارکری بپشکنە.",errorSummary:"هیڤییە ئەڤێن ل خوارێ راست بکە:",operationalDetails:"هویرکاتیێن کارکرنێ",backToOrganizations:"ب ڤەگەرە بو رێکخراوان",backToClinics:"ب ڤەگەرە بو کلینیکان",openOrganizations:"رێکخراوان ڤەکە",openClinics:"کلینیک ڤەکرییە",onboarding:"زێدەکرن"};
